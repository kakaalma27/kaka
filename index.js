...
function generateTokenName() {
    const date = new Date();
    const seed = parseInt(date.getTime() / 86400000); // Mengubah ke days since epoch
...
function generateTokenSymbol(tokenName) {
    ...
    // Pattern selector based on time
    const patternType = minuteInDay % 3;

    switch (patternType) {
        case 0:
            // Use first chars of each part
